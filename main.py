...
from modules.risk_assessment import analyze_user_risk_profile
from modules.fund_filtering import create_portfolio_recommendations

# Step 1: Get risk assessment
user_risk = analyze_user_risk_profile(user_data)
risk_score = user_risk['risk_score']

# Step 2: Get fund recommendations  
portfolio = create_portfolio_recommendations(fund_universe, risk_score)

print(f"User Risk: {user_risk['risk_category']}")
print(f"Portfolio: {portfolio['total_categories']} categories selected")
